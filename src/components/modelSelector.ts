...
import { MODELS, type ModelType, isWebGPUAvailable } from '../lib/backgroundRemoval'
...
class ModelSelector extends LitElement {
  ...
  declare selectedModel: ModelType
  declare disabled: boolean
  declare loadingStatus: string
...
defineComponent('model-selector', ModelSelector)
